...
namespace DeadInternet.Server.Migrations
{
    ...
    [Migration("20240917172937_UpdateCommentDeleteBehavior")]
    partial class UpdateCommentDeleteBehavior
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeadInternet.Server.Models.Comment", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DeadInternet.Server.Models.Comment", b =>
                {
                    b.HasOne("DeadInternet.Server.Models.Comment", "ParentComment")
                        .WithMany("Replies")
                        .HasForeignKey("ParentCommentId");

                    b.HasOne("DeadInternet.Server.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DeadInternet.Server.Models.AppUser", null)
                        .WithMany()
